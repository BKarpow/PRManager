...
class DateProductPolicy
{
     ...
     */
    public function restore(User $user, DateProduct $dateProduct): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, DateProduct $dateProduct): bool
    {
        return false;
    }
}
