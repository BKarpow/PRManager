...
@section('title') {{ $shop->name }} - групи товарів @endsection
                    ...
                    <div class="card-body">
                        ...
                        @if ($data->count() == 0)
                            <div class="alert alert-info">
                                <strong>Ще немає в базі груп  створіть нову!</strong>
                            </div>
                            <!-- /.alert -->
                        @else
                            <h3>Групи</h3>
